...
class GeographyClient {
    ...
    {
        return call_user_func($this->invoker, "eolymp.playground.Geography/DescribeCountry", $input, DescribeCountryOutput::class, $context);
    }
    ...
    {
        return call_user_func($this->invoker, "eolymp.playground.Geography/ListCountries", $input, ListCountriesOutput::class, $context);
    }
