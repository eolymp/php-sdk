...
namespace Eolymp\Automation\Condition\Timestamp;

use UnexpectedValueException;

/**
 * Protobuf type <code>eolymp.automation.Condition.Timestamp.Operator</code>
 */
class Operator
{
    /**
...
class_alias(Operator::class, \Eolymp\Automation\Condition_Timestamp_Operator::class);
