...
/**
 * Generated from protobuf message <code>eolymp.geography.ListCountriesOutput</code>
 */
class ListCountriesOutput extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Eolymp\Geography\Country::class);
        $this->items = $arr;
