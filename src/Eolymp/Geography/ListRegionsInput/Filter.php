...
namespace Eolymp\Geography\ListRegionsInput;
...
/**
 * Generated from protobuf message <code>eolymp.geography.ListRegionsInput.Filter</code>
 */
...
class_alias(Filter::class, \Eolymp\Geography\ListRegionsInput_Filter::class);
