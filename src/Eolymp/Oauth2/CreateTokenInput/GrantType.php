...
namespace Eolymp\Oauth2\CreateTokenInput;

use UnexpectedValueException;

/**
 * Protobuf type <code>eolymp.oauth2.CreateTokenInput.GrantType</code>
 */
class GrantType
{
    /**
...
class_alias(GrantType::class, \Eolymp\Oauth2\CreateTokenInput_GrantType::class);
