...
namespace Eolymp\Atlas\UpdateTopicInput;

use UnexpectedValueException;

/**
 * Protobuf type <code>eolymp.atlas.UpdateTopicInput.Patch</code>
 */
class Patch
{
    /**
...
class_alias(Patch::class, \Eolymp\Atlas\UpdateTopicInput_Patch::class);
