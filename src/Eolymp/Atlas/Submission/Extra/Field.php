...
namespace Eolymp\Atlas\Submission\Extra;

use UnexpectedValueException;

/**
 * Protobuf type <code>eolymp.atlas.Submission.Extra.Field</code>
 */
class Field
{
    /**
...
class_alias(Field::class, \Eolymp\Atlas\Submission_Extra_Field::class);
