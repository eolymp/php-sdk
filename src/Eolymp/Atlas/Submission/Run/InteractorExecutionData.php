...
/**
 * Generated from protobuf message <code>eolymp.atlas.Submission.Run.InteractorExecutionData</code>
 */
...
class_alias(InteractorExecutionData::class, \Eolymp\Atlas\Submission_Run_InteractorExecutionData::class);
