...
namespace Eolymp\Atlas\ListTopicsInput;
...
/**
 * Generated from protobuf message <code>eolymp.atlas.ListTopicsInput.Filter</code>
 */
...
class_alias(Filter::class, \Eolymp\Atlas\ListTopicsInput_Filter::class);
