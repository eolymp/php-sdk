...
/**
 * Generated from protobuf message <code>eolymp.atlas.Change.CreateProblem</code>
 */
class CreateProblem extends \Google\Protobuf\Internal\Message
{
    /**
...
class_alias(CreateProblem::class, \Eolymp\Atlas\Change_CreateProblem::class);
