...
/**
 * Generated from protobuf message <code>eolymp.atlas.Change.UpdateTemplate</code>
 */
class UpdateTemplate extends \Google\Protobuf\Internal\Message
{
    /**
...
class_alias(UpdateTemplate::class, \Eolymp\Atlas\Change_UpdateTemplate::class);
