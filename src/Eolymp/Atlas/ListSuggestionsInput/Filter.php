...
namespace Eolymp\Atlas\ListSuggestionsInput;
...
/**
 * Generated from protobuf message <code>eolymp.atlas.ListSuggestionsInput.Filter</code>
 */
...
class_alias(Filter::class, \Eolymp\Atlas\ListSuggestionsInput_Filter::class);
