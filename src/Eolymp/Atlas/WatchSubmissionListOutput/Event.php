...
namespace Eolymp\Atlas\WatchSubmissionListOutput;

use UnexpectedValueException;

/**
 * Protobuf type <code>eolymp.atlas.WatchSubmissionListOutput.Event</code>
 */
class Event
{
    /**
...
class_alias(Event::class, \Eolymp\Atlas\WatchSubmissionListOutput_Event::class);
