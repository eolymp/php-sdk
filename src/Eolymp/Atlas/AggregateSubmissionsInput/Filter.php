...
/**
 * Generated from protobuf message <code>eolymp.atlas.AggregateSubmissionsInput.Filter</code>
 */
...
class_alias(Filter::class, \Eolymp\Atlas\AggregateSubmissionsInput_Filter::class);
