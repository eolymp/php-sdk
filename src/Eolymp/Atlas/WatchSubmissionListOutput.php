...
/**
 * Generated from protobuf message <code>eolymp.atlas.WatchSubmissionListOutput</code>
 */
class WatchSubmissionListOutput extends \Google\Protobuf\Internal\Message
{
    /**
     * Generated from protobuf field <code>.eolymp.atlas.WatchSubmissionListOutput.Event event = 1;</code>
     */
    protected $event = 0;
    /**
     * Generated from protobuf field <code>.eolymp.atlas.Submission submission = 2;</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Eolymp\Atlas\WatchSubmissionListOutput\Event::class);
        $this->event = $var;
