...
namespace Eolymp\Atlas\Statement\Extra;

use UnexpectedValueException;

/**
 * Protobuf type <code>eolymp.atlas.Statement.Extra.Field</code>
 */
class Field
{
    /**
...
class_alias(Field::class, \Eolymp\Atlas\Statement_Extra_Field::class);
