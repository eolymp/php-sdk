...
/**
 * Generated from protobuf message <code>eolymp.atlas.CompleteMultipartUploadInput</code>
 */
class CompleteMultipartUploadInput extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Eolymp\Atlas\CompleteMultipartUploadInput\Part::class);
        $this->parts = $arr;
