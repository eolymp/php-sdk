...
/**
 * Generated from protobuf message <code>eolymp.atlas.Run</code>
 */
class Run extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.eolymp.atlas.Run.Status status = 20;</code>
     */
    protected $status = 0;
    /**
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Eolymp\Atlas\Run::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Eolymp\Atlas\Run\Status::class);
        $this->status = $var;
