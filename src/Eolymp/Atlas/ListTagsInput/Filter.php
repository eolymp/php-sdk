...
namespace Eolymp\Atlas\ListTagsInput;
...
/**
 * Generated from protobuf message <code>eolymp.atlas.ListTagsInput.Filter</code>
 */
...
class_alias(Filter::class, \Eolymp\Atlas\ListTagsInput_Filter::class);
