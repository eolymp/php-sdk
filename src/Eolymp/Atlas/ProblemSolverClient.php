...
class ProblemSolverClient {
    ...
    public function ListStatements(ListStatementsInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.atlas.ProblemSolver/ListStatements";
        $context['path'] = $path;
    ...
    public function ListExamples(ListExamplesInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.atlas.ProblemSolver/ListExamples";
        $context['path'] = $path;
    ...
    public function CreateSubmission(CreateSubmissionInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.atlas.ProblemSolver/CreateSubmission";
        $context['path'] = $path;
    ...
    public function ListSubmissions(ListSubmissionsInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.atlas.ProblemSolver/ListSubmissions";
        $context['path'] = $path;
    ...
    public function DescribeSubmission(DescribeSubmissionInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.atlas.ProblemSolver/DescribeSubmission";
        $context['path'] = $path;
    ...
    public function DescribeScore(DescribeScoreInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.atlas.ProblemSolver/DescribeScore";
        $context['path'] = $path;
    ...
    public function LookupCodeTemplate(LookupCodeTemplateInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.atlas.ProblemSolver/LookupCodeTemplate";
        $context['path'] = $path;
