...
/**
 * Generated from protobuf message <code>eolymp.atlas.Topic.Translation</code>
 */
class Translation extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Eolymp\Atlas\TaxonomyTopic::initOnce();
...
class_alias(Translation::class, \Eolymp\Atlas\Topic_Translation::class);
