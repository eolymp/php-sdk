...
/**
 * Generated from protobuf message <code>eolymp.atlas.ListSolutionsOutput</code>
 */
class ListSolutionsOutput extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    protected $total = 0;
    /**
     * Generated from protobuf field <code>repeated .eolymp.atlas.Solution items = 2;</code>
     */
    private $items;
     ...
     *
     *     @type int $total
     *     @type array<\Eolymp\Atlas\Solution>|\Google\Protobuf\Internal\RepeatedField $items
     * }
     */
