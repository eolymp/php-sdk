...
namespace Eolymp\Atlas;
    ...
    /**
     * Topic service allows to manage atlas topics.
     */
class TopicServiceClient {
    ...
    public function CreateTopic(CreateTopicInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.atlas.TopicService/CreateTopic";
        $context['path'] = $path;
    ...
    public function DeleteTopic(DeleteTopicInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.atlas.TopicService/DeleteTopic";
        $context['path'] = $path;
    ...
    public function UpdateTopic(UpdateTopicInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.atlas.TopicService/UpdateTopic";
        $context['path'] = $path;
    ...
    public function DescribeTopic(DescribeTopicInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.atlas.TopicService/DescribeTopic";
        $context['path'] = $path;
    ...
    public function ListTopics(ListTopicsInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.atlas.TopicService/ListTopics";
        $context['path'] = $path;
    ...
    public function TranslateTopic(TranslateTopicInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.atlas.TopicService/TranslateTopic";
        $context['path'] = $path;
    ...
    public function DeleteTranslation(DeleteTranslationInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.atlas.TopicService/DeleteTranslation";
        $context['path'] = $path;
    ...
    public function ListTranslations(ListTranslationsInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.atlas.TopicService/ListTranslations";
        $context['path'] = $path;
