...
namespace Eolymp\Atlas\ListMessageChangesOutput;
...
/**
 * Generated from protobuf message <code>eolymp.atlas.ListMessageChangesOutput.Record</code>
 */
...
class_alias(Record::class, \Eolymp\Atlas\ListMessageChangesOutput_Record::class);
