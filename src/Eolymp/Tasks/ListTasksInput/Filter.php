...
namespace Eolymp\Tasks\ListTasksInput;
...
/**
 * Generated from protobuf message <code>eolymp.tasks.ListTasksInput.Filter</code>
 */
...
class_alias(Filter::class, \Eolymp\Tasks\ListTasksInput_Filter::class);
