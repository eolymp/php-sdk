...
namespace Eolymp\Copilot\ListMessagesInput;
...
/**
 * Generated from protobuf message <code>eolymp.copilot.ListMessagesInput.Filter</code>
 */
...
class_alias(Filter::class, \Eolymp\Copilot\ListMessagesInput_Filter::class);
