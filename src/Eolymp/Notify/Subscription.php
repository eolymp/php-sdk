...
/**
 * Generated from protobuf message <code>eolymp.notify.Subscription</code>
 */
class Subscription extends \Google\Protobuf\Internal\Message
{
    ...
    protected $topic = '';
    /**
     * Generated from protobuf field <code>.eolymp.notify.Subscription.Digest digest = 2;</code>
     */
    protected $digest = 0;
    ...
    {
        GPBUtil::checkEnum($var, \Eolymp\Notify\Subscription\Digest::class);
        $this->digest = $var;
