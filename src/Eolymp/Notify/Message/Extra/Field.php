...
namespace Eolymp\Notify\Message\Extra;

use UnexpectedValueException;

/**
 * Protobuf type <code>eolymp.notify.Message.Extra.Field</code>
 */
class Field
{
    /**
...
class_alias(Field::class, \Eolymp\Notify\Message_Extra_Field::class);
