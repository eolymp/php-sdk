...
namespace Eolymp\Notify\ListChannelsInput;
...
/**
 * Generated from protobuf message <code>eolymp.notify.ListChannelsInput.Filter</code>
 */
...
class_alias(Filter::class, \Eolymp\Notify\ListChannelsInput_Filter::class);
