...
/**
 * Generated from protobuf message <code>eolymp.l10n.ListTermsOutput</code>
 */
class ListTermsOutput extends \Google\Protobuf\Internal\Message
{
    ...
    protected $total = 0;
    /**
     * Generated from protobuf field <code>repeated .eolymp.l10n.Term items = 2;</code>
     */
    private $items;
     ...
     *
     *     @type int $total
     *     @type array<\Eolymp\L10n\Term>|\Google\Protobuf\Internal\RepeatedField $items
     * }
     */
