...
class ListAssignmentsInput extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.eolymp.course.ListAssignmentsInput.Filter filters = 40;</code>
     * @return \Eolymp\Course\ListAssignmentsInput\Filter
     */
    ...
    {
        GPBUtil::checkMessage($var, \Eolymp\Course\ListAssignmentsInput_Filter::class);
        $this->filters = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Eolymp\Course\ListAssignmentsInput_Sortable::class);
        $this->sort = $var;
