...
/**
 * Generated from protobuf message <code>eolymp.course.ListAssignmentsInput</code>
 */
class ListAssignmentsInput extends \Google\Protobuf\Internal\Message
{
    /**
     * pagination
     *
     ...
     * data filters
     *
     * Generated from protobuf field <code>.eolymp.course.ListAssignmentsInput.Filter filters = 40;</code>
     */
    protected $filters = null;
    /**
     * Generated from protobuf field <code>.eolymp.course.ListAssignmentsInput.Sortable sort = 50;</code>
     */
    protected $sort = 0;
    /**
     ...
     *           pagination
     *     @type int $size
     *     @type \Eolymp\Course\ListAssignmentsInput\Filter $filters
     *           data filters
     *     @type int $sort
     *     @type int $order
     ...
     *
     * Generated from protobuf field <code>.eolymp.course.ListAssignmentsInput.Filter filters = 40;</code>
     * @return \Eolymp\Course\ListAssignmentsInput\Filter|null
     */
     ...
     *
     * Generated from protobuf field <code>.eolymp.course.ListAssignmentsInput.Filter filters = 40;</code>
     * @param \Eolymp\Course\ListAssignmentsInput\Filter $var
     * @return $this
     */
    public function setFilters($var)
    {
        GPBUtil::checkMessage($var, \Eolymp\Course\ListAssignmentsInput\Filter::class);
        $this->filters = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Eolymp\Course\ListAssignmentsInput\Sortable::class);
        $this->sort = $var;
