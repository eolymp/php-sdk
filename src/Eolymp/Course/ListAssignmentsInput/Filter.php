...
namespace Eolymp\Course\ListAssignmentsInput;
...
/**
 * Generated from protobuf message <code>eolymp.course.ListAssignmentsInput.Filter</code>
 */
...
class_alias(Filter::class, \Eolymp\Course\ListAssignmentsInput_Filter::class);
