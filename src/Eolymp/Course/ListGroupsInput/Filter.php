...
namespace Eolymp\Course\ListGroupsInput;
...
/**
 * Generated from protobuf message <code>eolymp.course.ListGroupsInput.Filter</code>
 */
...
class_alias(Filter::class, \Eolymp\Course\ListGroupsInput_Filter::class);
