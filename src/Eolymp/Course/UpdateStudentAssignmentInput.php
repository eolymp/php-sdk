...
/**
 * Generated from protobuf message <code>eolymp.course.UpdateStudentAssignmentInput</code>
 */
class UpdateStudentAssignmentInput extends \Google\Protobuf\Internal\Message
{
    /**
