...
namespace Eolymp\Course\UpdateMaterialInput;

use UnexpectedValueException;

/**
 * Protobuf type <code>eolymp.course.UpdateMaterialInput.Patch</code>
 */
class Patch
{
    /**
...
class_alias(Patch::class, \Eolymp\Course\UpdateMaterialInput_Patch::class);
