...
namespace Eolymp\Course\AssignmentX;

use UnexpectedValueException;

/**
 * Protobuf type <code>eolymp.course.AssignmentX.Status</code>
 */
class Status
{
    /**
...
class_alias(Status::class, \Eolymp\Course\AssignmentX_Status::class);
