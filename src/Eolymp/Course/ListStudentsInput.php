...
class ListStudentsInput extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.eolymp.course.ListStudentsInput.Filter filters = 40;</code>
     * @return \Eolymp\Course\ListStudentsInput\Filter
     */
    ...
    {
        GPBUtil::checkMessage($var, \Eolymp\Course\ListStudentsInput_Filter::class);
        $this->filters = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Eolymp\Course\ListStudentsInput_Sortable::class);
        $this->sort = $var;
