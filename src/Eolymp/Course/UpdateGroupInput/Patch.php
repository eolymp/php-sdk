...
namespace Eolymp\Course\UpdateGroupInput;

use UnexpectedValueException;

/**
 * Protobuf type <code>eolymp.course.UpdateGroupInput.Patch</code>
 */
class Patch
{
    /**
...
class_alias(Patch::class, \Eolymp\Course\UpdateGroupInput_Patch::class);
