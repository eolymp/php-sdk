...
namespace Eolymp\Course\Module\Progress;

use UnexpectedValueException;

/**
 * Protobuf type <code>eolymp.course.Module.Progress.Status</code>
 */
class Status
{
    /**
...
class_alias(Status::class, \Eolymp\Course\Module_Progress_Status::class);
