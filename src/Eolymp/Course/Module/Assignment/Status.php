...
namespace Eolymp\Course\Module\Assignment;

use UnexpectedValueException;

/**
 * Protobuf type <code>eolymp.course.Module.Assignment.Status</code>
 */
class Status
{
    /**
...
class_alias(Status::class, \Eolymp\Course\Module_Assignment_Status::class);
