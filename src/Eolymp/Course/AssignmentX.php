...
/**
 * Generated from protobuf message <code>eolymp.course.AssignmentX</code>
 */
class AssignmentX extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * Generated from protobuf field <code>.eolymp.course.AssignmentX.Status status = 10;</code>
     */
    protected $status = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Eolymp\Course\AssignmentX\Status::class);
        $this->status = $var;
