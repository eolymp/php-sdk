...
class ListEntriesInput extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.eolymp.course.ListEntriesInput.Filter filters = 40;</code>
     * @return \Eolymp\Course\ListEntriesInput\Filter|null
     */
    ...
    {
        GPBUtil::checkMessage($var, \Eolymp\Course\ListEntriesInput\Filter::class);
        $this->filters = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Eolymp\Course\ListEntriesInput\Sortable::class);
        $this->sort = $var;
