 ...
 */
class ListStudentsOutput extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     *     @type int $total
     *     @type \Eolymp\Course\Student[]|\Google\Protobuf\Internal\RepeatedField $items
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>repeated .eolymp.course.Student items = 2;</code>
     * @param \Eolymp\Course\Student[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setItems($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Eolymp\Course\Student::class);
        $this->items = $arr;
