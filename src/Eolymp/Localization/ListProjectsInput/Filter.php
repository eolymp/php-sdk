...
namespace Eolymp\Localization\ListProjectsInput;
...
/**
 * Generated from protobuf message <code>eolymp.localization.ListProjectsInput.Filter</code>
 */
...
class_alias(Filter::class, \Eolymp\Localization\ListProjectsInput_Filter::class);
