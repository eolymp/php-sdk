...
namespace Eolymp\Localization\ListTermsInput;
...
/**
 * Generated from protobuf message <code>eolymp.localization.ListTermsInput.Filter</code>
 */
...
class_alias(Filter::class, \Eolymp\Localization\ListTermsInput_Filter::class);
