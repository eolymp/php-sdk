...
class LocalizationServiceClient {
    ...
    public function CreateTerm(CreateTermInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.localization.LocalizationService/CreateTerm";
        $context['path'] = $path;
    ...
    public function ListTerms(ListTermsInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.localization.LocalizationService/ListTerms";
        $context['path'] = $path;
    ...
    public function UpdateTerm(UpdateTermInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.localization.LocalizationService/UpdateTerm";
        $context['path'] = $path;
    ...
    public function ApproveTerm(ApproveTermInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.localization.LocalizationService/ApproveTerm";
        $context['path'] = $path;
    ...
    public function DeprecateTerm(DeprecateTermInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.localization.LocalizationService/DeprecateTerm";
        $context['path'] = $path;
    ...
    public function DeleteTerm(DeleteTermInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.localization.LocalizationService/DeleteTerm";
        $context['path'] = $path;
    ...
    public function DescribeTerm(DescribeTermInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.localization.LocalizationService/DescribeTerm";
        $context['path'] = $path;
    ...
    public function ImportTerms(ImportTermsInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.localization.LocalizationService/ImportTerms";
        $context['path'] = $path;
    ...
    public function TranslateTerm(TranslateTermInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.localization.LocalizationService/TranslateTerm";
        $context['path'] = $path;
    ...
    public function ListTranslations(ListTranslationsInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.localization.LocalizationService/ListTranslations";
        $context['path'] = $path;
    ...
    public function DeleteTranslation(DeleteTranslationInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.localization.LocalizationService/DeleteTranslation";
        $context['path'] = $path;
    ...
    public function UpdateTranslation(UpdateTranslationInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.localization.LocalizationService/UpdateTranslation";
        $context['path'] = $path;
    ...
    public function ApproveTranslation(ApproveTranslationInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.localization.LocalizationService/ApproveTranslation";
        $context['path'] = $path;
    ...
    public function RejectTranslation(RejectTranslationInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.localization.LocalizationService/RejectTranslation";
        $context['path'] = $path;
    ...
    public function ImportTranslations(ImportTranslationsInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.localization.LocalizationService/ImportTranslations";
        $context['path'] = $path;
    ...
    public function ExportTranslations(ExportTranslationsInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.localization.LocalizationService/ExportTranslations";
        $context['path'] = $path;

        return call_user_func($this->invoker, "GET", $this->url.$path, $input, ImportTranslationsOutput::class, $context);
    }
