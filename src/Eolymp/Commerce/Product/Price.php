...
/**
 * Generated from protobuf message <code>eolymp.commerce.Product.Price</code>
 */
class Price extends \Google\Protobuf\Internal\Message
{
    ...
    protected $id = '';
    /**
     * Generated from protobuf field <code>.eolymp.commerce.Product.Recurrence recurrence = 3;</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Eolymp\Commerce\Product_Recurrence::class);
        $this->recurrence = $var;
...
class_alias(Price::class, \Eolymp\Commerce\Product_Price::class);
