...
/**
 * Generated from protobuf message <code>eolymp.commerce.ListProductVariantsOutput</code>
 */
class ListProductVariantsOutput extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    protected $total = 0;
    /**
     * Generated from protobuf field <code>repeated .eolymp.commerce.Product.Variant items = 2;</code>
     */
    private $items;
     ...
     *
     *     @type int $total
     *     @type array<\Eolymp\Commerce\Product\Variant>|\Google\Protobuf\Internal\RepeatedField $items
     * }
     */
