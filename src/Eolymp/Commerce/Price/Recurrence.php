...
namespace Eolymp\Commerce\Price;

use UnexpectedValueException;

/**
 * Protobuf type <code>eolymp.commerce.Price.Recurrence</code>
 */
class Recurrence
{
    /**
...
class_alias(Recurrence::class, \Eolymp\Commerce\Price_Recurrence::class);
