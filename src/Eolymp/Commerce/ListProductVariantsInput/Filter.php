...
namespace Eolymp\Commerce\ListProductVariantsInput;
...
/**
 * Generated from protobuf message <code>eolymp.commerce.ListProductVariantsInput.Filter</code>
 */
...
class_alias(Filter::class, \Eolymp\Commerce\ListProductVariantsInput_Filter::class);
