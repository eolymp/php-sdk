...
namespace Eolymp\Taxonomy\ListEntriesInput;
...
/**
 * Generated from protobuf message <code>eolymp.taxonomy.ListEntriesInput.Filter</code>
 */
...
class_alias(Filter::class, \Eolymp\Taxonomy\ListEntriesInput_Filter::class);
