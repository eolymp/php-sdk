...
class ListRegionsOutput extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Eolymp\Taxonomy\Region[]|\Google\Protobuf\Internal\RepeatedField $items
     *     @type int $total
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>repeated .eolymp.taxonomy.Region items = 1;</code>
     * @param \Eolymp\Taxonomy\Region[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setItems($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Eolymp\Taxonomy\Region::class);
        $this->items = $arr;
