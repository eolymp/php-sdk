...
namespace Eolymp\Taxonomy\Entry;
...
/**
 * Generated from protobuf message <code>eolymp.taxonomy.Entry.Translation</code>
 */
class Translation extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Eolymp\Taxonomy\DatasetEntry::initOnce();
...
class_alias(Translation::class, \Eolymp\Taxonomy\Entry_Translation::class);
