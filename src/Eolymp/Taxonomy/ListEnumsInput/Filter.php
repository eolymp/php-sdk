...
namespace Eolymp\Taxonomy\ListEnumsInput;
...
/**
 * Generated from protobuf message <code>eolymp.taxonomy.ListEnumsInput.Filter</code>
 */
...
class_alias(Filter::class, \Eolymp\Taxonomy\ListEnumsInput_Filter::class);
