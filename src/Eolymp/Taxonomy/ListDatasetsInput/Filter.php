...
namespace Eolymp\Taxonomy\ListDatasetsInput;
...
/**
 * Generated from protobuf message <code>eolymp.taxonomy.ListDatasetsInput.Filter</code>
 */
...
class_alias(Filter::class, \Eolymp\Taxonomy\ListDatasetsInput_Filter::class);
