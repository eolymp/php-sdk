...
namespace Eolymp\Taxonomy\ListTopicsInput;
...
/**
 * Generated from protobuf message <code>eolymp.taxonomy.ListTopicsInput.Filter</code>
 */
...
class_alias(Filter::class, \Eolymp\Taxonomy\ListTopicsInput_Filter::class);
