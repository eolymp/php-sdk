...
class ListCountriesOutput extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Eolymp\Taxonomy\Country[]|\Google\Protobuf\Internal\RepeatedField $items
     *     @type int $total
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>repeated .eolymp.taxonomy.Country items = 1;</code>
     * @param \Eolymp\Taxonomy\Country[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setItems($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Eolymp\Taxonomy\Country::class);
        $this->items = $arr;
