...
namespace Eolymp\Typewriter\ListFragmentsInput;
...
/**
 * Generated from protobuf message <code>eolymp.typewriter.ListFragmentsInput.Filter</code>
 */
...
class_alias(Filter::class, \Eolymp\Typewriter\ListFragmentsInput_Filter::class);
