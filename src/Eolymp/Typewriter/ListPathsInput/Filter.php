...
namespace Eolymp\Typewriter\ListPathsInput;
...
/**
 * Generated from protobuf message <code>eolymp.typewriter.ListPathsInput.Filter</code>
 */
...
class_alias(Filter::class, \Eolymp\Typewriter\ListPathsInput_Filter::class);
