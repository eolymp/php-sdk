...
/**
 * Generated from protobuf message <code>eolymp.content.ModeratePostInput</code>
 */
class ModeratePostInput extends \Google\Protobuf\Internal\Message
{
    ...
    protected $post_id = '';
    /**
     * Generated from protobuf field <code>.eolymp.content.ModeratePostInput.Outcome outcome = 2;</code>
     */
    protected $outcome = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Eolymp\Content\ModeratePostInput\Outcome::class);
        $this->outcome = $var;
