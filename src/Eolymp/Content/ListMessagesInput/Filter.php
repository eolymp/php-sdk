...
/**
 * Generated from protobuf message <code>eolymp.content.ListMessagesInput.Filter</code>
 */
...
class_alias(Filter::class, \Eolymp\Content\ListMessagesInput_Filter::class);
