...
namespace Eolymp\Content\ListPathsInput;
...
/**
 * Generated from protobuf message <code>eolymp.content.ListPathsInput.Filter</code>
 */
...
class_alias(Filter::class, \Eolymp\Content\ListPathsInput_Filter::class);
