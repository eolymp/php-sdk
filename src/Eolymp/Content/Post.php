...
class Post extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type \Eolymp\Content\Post\Preview $preview
     *           preview is generated automatically from the content
     *     @type int $vote
     *           vote of authenticated user (+1 or -1)
     *     @type int $vote_count
    ...
    {
        GPBUtil::checkEnum($var, \Eolymp\Content\Post\Moderation::class);
        $this->moderation = $var;
    ...
    {
        GPBUtil::checkMessage($var, \Eolymp\Content\Post\Preview::class);
        $this->preview = $var;
