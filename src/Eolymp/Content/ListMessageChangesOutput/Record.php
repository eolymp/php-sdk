...
namespace Eolymp\Content\ListMessageChangesOutput;
...
/**
 * Generated from protobuf message <code>eolymp.content.ListMessageChangesOutput.Record</code>
 */
...
class_alias(Record::class, \Eolymp\Content\ListMessageChangesOutput_Record::class);
