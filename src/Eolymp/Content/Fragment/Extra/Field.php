...
namespace Eolymp\Content\Fragment\Extra;

use UnexpectedValueException;

/**
 * Protobuf type <code>eolymp.content.Fragment.Extra.Field</code>
 */
class Field
{
    /**
...
class_alias(Field::class, \Eolymp\Content\Fragment_Extra_Field::class);
