...
/**
 * Generated from protobuf message <code>eolymp.mail.Recipient</code>
 */
class Recipient extends \Google\Protobuf\Internal\Message
{
    ...
    protected $member_id = '';
    /**
     * Generated from protobuf field <code>.eolymp.mail.Recipient.Status status = 3;</code>
     */
    protected $status = 0;
    /**
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Eolymp\Mail\NewsletterRecipient::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Eolymp\Mail\Recipient\Status::class);
        $this->status = $var;
