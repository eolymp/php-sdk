...
/**
 * Generated from protobuf message <code>eolymp.mail.ListNewslettersInput</code>
 */
class ListNewslettersInput extends \Google\Protobuf\Internal\Message
{
    ...
    protected $size = 0;
    /**
     * Generated from protobuf field <code>.eolymp.mail.ListNewslettersInput.Filter filters = 40;</code>
     */
    ...
    protected $search = '';
    /**
     * Generated from protobuf field <code>.eolymp.mail.ListNewslettersInput.Sort sort = 50;</code>
     */
    protected $sort = 0;
    /**
     ...
     *     @type int $offset
     *     @type int $size
     *     @type \Eolymp\Mail\ListNewslettersInput\Filter $filters
     *     @type string $search
     *     @type int $sort
     *     @type int $order
     *     @type string $locale
    ...
    /**
     * Generated from protobuf field <code>.eolymp.mail.ListNewslettersInput.Filter filters = 40;</code>
     * @return \Eolymp\Mail\ListNewslettersInput\Filter|null
     */
    ...
    /**
     * Generated from protobuf field <code>.eolymp.mail.ListNewslettersInput.Filter filters = 40;</code>
     * @param \Eolymp\Mail\ListNewslettersInput\Filter $var
     * @return $this
     */
    public function setFilters($var)
    {
        GPBUtil::checkMessage($var, \Eolymp\Mail\ListNewslettersInput\Filter::class);
        $this->filters = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Eolymp\Mail\ListNewslettersInput\Sort::class);
        $this->sort = $var;
