...
namespace Eolymp\Mail\ListTranslationsInput;
...
/**
 * Generated from protobuf message <code>eolymp.mail.ListTranslationsInput.Filter</code>
 */
...
class_alias(Filter::class, \Eolymp\Mail\ListTranslationsInput_Filter::class);
