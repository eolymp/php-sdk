...
namespace Eolymp\Mail\ImportRecipientInput;
...
/**
 * Generated from protobuf message <code>eolymp.mail.ImportRecipientInput.Filter</code>
 */
class Filter extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>repeated .eolymp.mail.ImportRecipientInput.Filter.ExpressionAttribute attribute = 107;</code>
     * @param array<\Eolymp\Mail\ImportRecipientInput\Filter\ExpressionAttribute>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setAttribute($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Eolymp\Mail\ImportRecipientInput\Filter\ExpressionAttribute::class);
        $this->attribute = $arr;
...
class_alias(Filter::class, \Eolymp\Mail\ImportRecipientInput_Filter::class);
