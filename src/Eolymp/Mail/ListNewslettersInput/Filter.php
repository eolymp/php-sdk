...
namespace Eolymp\Mail\ListNewslettersInput;
...
/**
 * Generated from protobuf message <code>eolymp.mail.ListNewslettersInput.Filter</code>
 */
...
class_alias(Filter::class, \Eolymp\Mail\ListNewslettersInput_Filter::class);
