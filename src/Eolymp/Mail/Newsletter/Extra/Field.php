...
namespace Eolymp\Mail\Newsletter\Extra;

use UnexpectedValueException;

/**
 * Protobuf type <code>eolymp.mail.Newsletter.Extra.Field</code>
 */
class Field
{
    /**
...
class_alias(Field::class, \Eolymp\Mail\Newsletter_Extra_Field::class);
