...
namespace Eolymp\Mail\ListRecipientsInput;
...
/**
 * Generated from protobuf message <code>eolymp.mail.ListRecipientsInput.Filter</code>
 */
...
class_alias(Filter::class, \Eolymp\Mail\ListRecipientsInput_Filter::class);
