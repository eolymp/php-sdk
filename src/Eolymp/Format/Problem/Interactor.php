...
/**
 * Generated from protobuf message <code>eolymp.format.Problem.Interactor</code>
 */
class Interactor extends \Google\Protobuf\Internal\Message
{
    ...
    protected $source = '';
    /**
     * Generated from protobuf field <code>repeated .eolymp.format.Problem.File files = 3;</code>
     */
    private $files;
...
class_alias(Interactor::class, \Eolymp\Format\Problem_Interactor::class);
