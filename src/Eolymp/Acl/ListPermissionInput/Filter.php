...
namespace Eolymp\Acl\ListPermissionInput;
...
/**
 * Generated from protobuf message <code>eolymp.acl.ListPermissionInput.Filter</code>
 */
...
class_alias(Filter::class, \Eolymp\Acl\ListPermissionInput_Filter::class);
