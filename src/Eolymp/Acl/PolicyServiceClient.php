...
class PolicyServiceClient {
    ...
    public function CreatePolicy(CreatePolicyInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.acl.PolicyService/CreatePolicy";
        $context['path'] = $path;
    ...
    {
        $path = "/policies/".rawurlencode($input->getPolicyId());

        // Cleanup URL parameters to avoid any ambiguity
        $input->setPolicyId("");

        $context['name'] = "eolymp.acl.PolicyService/UpdatePolicy";
        $context['path'] = $path;
    ...
    public function DeletePolicy(DeletePolicyInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.acl.PolicyService/DeletePolicy";
        $context['path'] = $path;
    ...
    public function DescribePolicy(DescribePolicyInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.acl.PolicyService/DescribePolicy";
        $context['path'] = $path;
    ...
    public function ListPolicies(ListPoliciesInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.acl.PolicyService/ListPolicies";
        $context['path'] = $path;
