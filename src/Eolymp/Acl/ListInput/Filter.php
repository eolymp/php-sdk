...
namespace Eolymp\Acl\ListInput;
...
/**
 * Generated from protobuf message <code>eolymp.acl.ListInput.Filter</code>
 */
...
class_alias(Filter::class, \Eolymp\Acl\ListInput_Filter::class);
