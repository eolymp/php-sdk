...
/**
 * Generated from protobuf message <code>eolymp.vendor.Vendor</code>
 */
class Vendor extends \Google\Protobuf\Internal\Message
{
    ...
    protected $id = '';
    /**
     * Generated from protobuf field <code>.eolymp.vendor.Vendor.Status status = 2;</code>
     */
    protected $status = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Eolymp\Vendor\Vendor\Status::class);
        $this->status = $var;
