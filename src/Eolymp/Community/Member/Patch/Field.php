...
namespace Eolymp\Community\Member\Patch;

use UnexpectedValueException;

/**
 * Protobuf type <code>eolymp.community.Member.Patch.Field</code>
 */
class Field
{
    /**
    ...
    /**
     * Generated from protobuf enum <code>METADATA = 901;</code>
     */
    const METADATA = 901;
...
class_alias(Field::class, \Eolymp\Community\Member_Patch_Field::class);
