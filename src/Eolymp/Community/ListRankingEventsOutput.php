...
/**
 * Generated from protobuf message <code>eolymp.community.ListRankingEventsOutput</code>
 */
class ListRankingEventsOutput extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Eolymp\Community\RankingEvent::class);
        $this->items = $arr;
