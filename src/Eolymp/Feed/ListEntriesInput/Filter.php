...
namespace Eolymp\Feed\ListEntriesInput;
...
/**
 * Generated from protobuf message <code>eolymp.feed.ListEntriesInput.Filter</code>
 */
...
class_alias(Filter::class, \Eolymp\Feed\ListEntriesInput_Filter::class);
