...
namespace Eolymp\Polyglot\ListTasksInput;
...
/**
 * Generated from protobuf message <code>eolymp.polyglot.ListTasksInput.Filter</code>
 */
...
class_alias(Filter::class, \Eolymp\Polyglot\ListTasksInput_Filter::class);
