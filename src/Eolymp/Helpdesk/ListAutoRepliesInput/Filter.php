...
namespace Eolymp\Helpdesk\ListAutoRepliesInput;
...
/**
 * Generated from protobuf message <code>eolymp.helpdesk.ListAutoRepliesInput.Filter</code>
 */
...
class_alias(Filter::class, \Eolymp\Helpdesk\ListAutoRepliesInput_Filter::class);
