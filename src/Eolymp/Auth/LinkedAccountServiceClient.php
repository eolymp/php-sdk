...
class LinkedAccountServiceClient {
    ...
    public function RequestLinkedAccount(RequestLinkedAccountInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.auth.LinkedAccountService/RequestLinkedAccount";
        $context['path'] = $path;
    ...
    public function CreateLinkedAccount(CreateLinkedAccountInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.auth.LinkedAccountService/CreateLinkedAccount";
        $context['path'] = $path;
    ...
    public function DeleteLinkedAccount(DeleteLinkedAccountInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.auth.LinkedAccountService/DeleteLinkedAccount";
        $context['path'] = $path;
    ...
    public function DescribeLinkedAccount(DescribeLinkedAccountInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.auth.LinkedAccountService/DescribeLinkedAccount";
        $context['path'] = $path;
    ...
    public function ListLinkedAccounts(ListLinkedAccountsInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.auth.LinkedAccountService/ListLinkedAccounts";
        $context['path'] = $path;
