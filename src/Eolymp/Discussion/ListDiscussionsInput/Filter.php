...
namespace Eolymp\Discussion\ListDiscussionsInput;
...
/**
 * Generated from protobuf message <code>eolymp.discussion.ListDiscussionsInput.Filter</code>
 */
...
class_alias(Filter::class, \Eolymp\Discussion\ListDiscussionsInput_Filter::class);
