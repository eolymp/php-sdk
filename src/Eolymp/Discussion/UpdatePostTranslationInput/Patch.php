...
namespace Eolymp\Discussion\UpdatePostTranslationInput;

use UnexpectedValueException;

/**
 * Protobuf type <code>eolymp.discussion.UpdatePostTranslationInput.Patch</code>
 */
class Patch
{
    /**
...
class_alias(Patch::class, \Eolymp\Discussion\UpdatePostTranslationInput_Patch::class);
