...
/**
 * Generated from protobuf message <code>eolymp.discussion.ListPostTypeVariantsOutput</code>
 */
class ListPostTypeVariantsOutput extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    protected $total = 0;
    /**
     * Generated from protobuf field <code>repeated .eolymp.discussion.PostType.Variant items = 2;</code>
     */
    private $items;
     ...
     *
     *     @type int $total
     *     @type \Eolymp\Discussion\PostType\Variant[]|\Google\Protobuf\Internal\RepeatedField $items
     * }
     */
