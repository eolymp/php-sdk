...
/**
 * Generated from protobuf message <code>eolymp.discussion.CreatePostTypeVariantOutput</code>
 */
class CreatePostTypeVariantOutput extends \Google\Protobuf\Internal\Message
{
    /**
