...
namespace Eolymp\Newsletter\ListRecipientsInput;
...
/**
 * Generated from protobuf message <code>eolymp.newsletter.ListRecipientsInput.Filter</code>
 */
...
class_alias(Filter::class, \Eolymp\Newsletter\ListRecipientsInput_Filter::class);
