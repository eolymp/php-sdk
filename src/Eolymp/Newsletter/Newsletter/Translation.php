...
namespace Eolymp\Newsletter\Newsletter;
...
/**
 * Generated from protobuf message <code>eolymp.newsletter.Newsletter.Translation</code>
 */
...
class_alias(Translation::class, \Eolymp\Newsletter\Newsletter_Translation::class);
