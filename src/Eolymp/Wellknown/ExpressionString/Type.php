...
namespace Eolymp\Wellknown\ExpressionString;

use UnexpectedValueException;

/**
 * Protobuf type <code>eolymp.wellknown.ExpressionString.Type</code>
 */
class Type
{
    /**
...
class_alias(Type::class, \Eolymp\Wellknown\ExpressionString_Type::class);
