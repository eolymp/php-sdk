...
namespace Eolymp\Wellknown\ExpressionID;

use UnexpectedValueException;

/**
 * Protobuf type <code>eolymp.wellknown.ExpressionID.Type</code>
 */
class Type
{
    /**
...
class_alias(Type::class, \Eolymp\Wellknown\ExpressionID_Type::class);
