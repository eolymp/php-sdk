...
namespace Eolymp\Wellknown\ExpressionFloat;

use UnexpectedValueException;

/**
 * Protobuf type <code>eolymp.wellknown.ExpressionFloat.Type</code>
 */
class Type
{
    /**
...
class_alias(Type::class, \Eolymp\Wellknown\ExpressionFloat_Type::class);
