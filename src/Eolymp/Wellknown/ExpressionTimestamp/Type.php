...
namespace Eolymp\Wellknown\ExpressionTimestamp;

use UnexpectedValueException;

/**
 * Protobuf type <code>eolymp.wellknown.ExpressionTimestamp.Type</code>
 */
class Type
{
    /**
...
class_alias(Type::class, \Eolymp\Wellknown\ExpressionTimestamp_Type::class);
