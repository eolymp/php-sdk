...
/**
 * Generated from protobuf message <code>eolymp.universe.IdentityProvider.OIDC</code>
 */
class OIDC extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Eolymp\Universe\Idp::initOnce();
...
class_alias(OIDC::class, \Eolymp\Universe\IdentityProvider_OIDC::class);
