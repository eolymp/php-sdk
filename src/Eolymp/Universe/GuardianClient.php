...
class GuardianClient {
    ...
    public function ListPolicies(ListPoliciesInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.universe.Guardian/ListPolicies";
        $context['path'] = $path;
    ...
    public function DescribePolicy(DescribePolicyInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.universe.Guardian/DescribePolicy";
        $context['path'] = $path;
    ...
    public function DefinePolicy(DefinePolicyInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.universe.Guardian/DefinePolicy";
        $context['path'] = $path;
    ...
    public function RemovePolicy(RemovePolicyInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.universe.Guardian/RemovePolicy";
        $context['path'] = $path;
