...
namespace Eolymp\Universe\ListPermissionsInput;
...
/**
 * Generated from protobuf message <code>eolymp.universe.ListPermissionsInput.Filter</code>
 */
...
class_alias(Filter::class, \Eolymp\Universe\ListPermissionsInput_Filter::class);
