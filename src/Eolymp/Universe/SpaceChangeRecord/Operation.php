...
namespace Eolymp\Universe\SpaceChangeRecord;

use UnexpectedValueException;

/**
 * Protobuf type <code>eolymp.universe.SpaceChangeRecord.Operation</code>
 */
class Operation
{
    /**
    ...
    const DELETE = 3;
    /**
     * Generated from protobuf enum <code>SOFT_DELETE = 4;</code>
     */
    const SOFT_DELETE = 4;
...
class_alias(Operation::class, \Eolymp\Universe\SpaceChangeRecord_Operation::class);
