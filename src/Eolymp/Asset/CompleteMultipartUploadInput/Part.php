...
namespace Eolymp\Asset\CompleteMultipartUploadInput;
...
/**
 * Generated from protobuf message <code>eolymp.asset.CompleteMultipartUploadInput.Part</code>
 */
...
class_alias(Part::class, \Eolymp\Asset\CompleteMultipartUploadInput_Part::class);
