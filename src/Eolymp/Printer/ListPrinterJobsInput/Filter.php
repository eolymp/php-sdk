...
namespace Eolymp\Printer\ListPrinterJobsInput;
...
/**
 * Generated from protobuf message <code>eolymp.printer.ListPrinterJobsInput.Filter</code>
 */
...
class_alias(Filter::class, \Eolymp\Printer\ListPrinterJobsInput_Filter::class);
