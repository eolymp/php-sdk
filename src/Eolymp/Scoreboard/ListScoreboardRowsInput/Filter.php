...
/**
 * Generated from protobuf message <code>eolymp.scoreboard.ListScoreboardRowsInput.Filter</code>
 */
...
class_alias(Filter::class, \Eolymp\Scoreboard\ListScoreboardRowsInput_Filter::class);
