...
/**
 * Generated from protobuf message <code>eolymp.judge.Submission.InteractorExecutionData</code>
 */
...
class_alias(InteractorExecutionData::class, \Eolymp\Judge\Submission_InteractorExecutionData::class);
