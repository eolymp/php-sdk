...
/**
 * Generated from protobuf message <code>eolymp.judge.Submission.Run.VerifierExecutionData</code>
 */
...
class_alias(VerifierExecutionData::class, \Eolymp\Judge\Submission_Run_VerifierExecutionData::class);
