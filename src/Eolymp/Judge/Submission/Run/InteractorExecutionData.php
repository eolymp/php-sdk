...
/**
 * Generated from protobuf message <code>eolymp.judge.Submission.Run.InteractorExecutionData</code>
 */
...
class_alias(InteractorExecutionData::class, \Eolymp\Judge\Submission_Run_InteractorExecutionData::class);
