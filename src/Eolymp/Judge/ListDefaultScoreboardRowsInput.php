...
/**
 * Generated from protobuf message <code>eolymp.judge.ListDefaultScoreboardRowsInput</code>
 */
class ListDefaultScoreboardRowsInput extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * Generated from protobuf field <code>.eolymp.judge.ListScoreboardRowsInput.Filter filters = 40;</code>
     * @return \Eolymp\Judge\ListScoreboardRowsInput\Filter
     */
    ...
    {
        GPBUtil::checkMessage($var, \Eolymp\Judge\ListScoreboardRowsInput_Filter::class);
        $this->filters = $var;
