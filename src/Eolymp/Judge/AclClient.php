...
class AclClient {
    ...
    {
        $path = "/permissions/".rawurlencode($input->getUserId());

        // Cleanup URL parameters to avoid any ambiguity
        $input->setUserId("");

        $context['name'] = "eolymp.judge.Acl/GrantPermission";
        $context['path'] = $path;
    ...
    public function RevokePermission(RevokePermissionInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.judge.Acl/RevokePermission";
        $context['path'] = $path;
    ...
    public function DescribePermission(DescribePermissionInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.judge.Acl/DescribePermission";
        $context['path'] = $path;
    ...
    public function ListPermissions(ListPermissionsInput $input, array $context = [])
    {
        ...
        $context['name'] = "eolymp.judge.Acl/ListPermissions";
        $context['path'] = $path;
