...
/**
 * Generated from protobuf message <code>eolymp.judge.WatchSubmissionListOutput</code>
 */
class WatchSubmissionListOutput extends \Google\Protobuf\Internal\Message
{
    /**
     * Generated from protobuf field <code>.eolymp.judge.WatchSubmissionListOutput.Event event = 1;</code>
     */
    protected $event = 0;
    /**
     * Generated from protobuf field <code>.eolymp.judge.Submission submission = 2;</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Eolymp\Judge\WatchSubmissionListOutput\Event::class);
        $this->event = $var;
