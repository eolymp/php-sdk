...
namespace Eolymp\Judge\ListPermissionsInput;
...
/**
 * Generated from protobuf message <code>eolymp.judge.ListPermissionsInput.Filter</code>
 */
...
class_alias(Filter::class, \Eolymp\Judge\ListPermissionsInput_Filter::class);
