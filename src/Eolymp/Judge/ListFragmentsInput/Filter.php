...
namespace Eolymp\Judge\ListFragmentsInput;
...
/**
 * Generated from protobuf message <code>eolymp.judge.ListFragmentsInput.Filter</code>
 */
...
class_alias(Filter::class, \Eolymp\Judge\ListFragmentsInput_Filter::class);
