...
class Submission extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>float genai_use_probability = 48;</code>
     */
    protected $genai_use_probability = 0.0;
    /**
     ...
     *           maximum resource usage
     *     @type float $genai_use_probability
     *           Probability that the submission code was generated by an AI (0 to 1)
     ...
     * @return float
     */
    public function getGenaiUseProbability()
    {
        return $this->genai_use_probability;
    }
     ...
     * @return $this
     */
    public function setGenaiUseProbability($var)
    {
        GPBUtil::checkFloat($var);
        $this->genai_use_probability = $var;
