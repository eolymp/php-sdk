...
class Submission extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Probability that the submission code was generated by an AI (0 to 1)
     *
     * Generated from protobuf field <code>float gen_ai_use_score = 48;</code>
     */
    protected $gen_ai_use_score = 0.0;
    /**
     ...
     *           maximum resource usage
     *     @type float $gen_ai_use_score
     *           Probability that the submission code was generated by an AI (0 to 1)
     *     @type \Eolymp\Judge\Submission\Group[] $groups
     *           status for each run by group
     *     @type string $cursor
     *           cursor in the list
     * }
     ...
     * @return float
     */
    public function getGenAiUseScore()
    {
        return $this->gen_ai_use_score;
    }
     ...
     * @return $this
     */
    public function setGenAiUseScore($var)
    {
        GPBUtil::checkFloat($var);
        $this->gen_ai_use_score = $var;
     ...
     *
     * Generated from protobuf field <code>repeated .eolymp.judge.Submission.Group groups = 50;</code>
     * @return RepeatedField<\Eolymp\Judge\Submission\Group>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .eolymp.judge.Submission.Group groups = 50;</code>
     * @param \Eolymp\Judge\Submission\Group[] $var
     * @return $this
     */
