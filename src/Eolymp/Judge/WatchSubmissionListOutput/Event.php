...
namespace Eolymp\Judge\WatchSubmissionListOutput;

use UnexpectedValueException;

/**
 * Protobuf type <code>eolymp.judge.WatchSubmissionListOutput.Event</code>
 */
class Event
{
    /**
...
class_alias(Event::class, \Eolymp\Judge\WatchSubmissionListOutput_Event::class);
