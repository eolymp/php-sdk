...
/**
 * Generated from protobuf message <code>eolymp.judge.DescribeDefaultScoreboardRowInput</code>
 */
class DescribeDefaultScoreboardRowInput extends \Google\Protobuf\Internal\Message
{
    /**
