...
namespace Eolymp\Judge\WatchTicketsOutput;

use UnexpectedValueException;

/**
 * Protobuf type <code>eolymp.judge.WatchTicketsOutput.Event</code>
 */
class Event
{
    /**
...
class_alias(Event::class, \Eolymp\Judge\WatchTicketsOutput_Event::class);
