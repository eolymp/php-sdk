...
namespace Eolymp\Judge\Scoreboard\Attribute;
...
/**
 * Generated from protobuf message <code>eolymp.judge.Scoreboard.Attribute.Patch</code>
 */
...
class_alias(Patch::class, \Eolymp\Judge\Scoreboard_Attribute_Patch::class);
