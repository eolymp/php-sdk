...
/**
 * Generated from protobuf message <code>eolymp.judge.Scoreboard.ProblemScore</code>
 */
...
class_alias(ProblemScore::class, \Eolymp\Judge\Scoreboard_ProblemScore::class);
