...
namespace Eolymp\Judge\WatchAnnouncementsOutput;

use UnexpectedValueException;

/**
 * Protobuf type <code>eolymp.judge.WatchAnnouncementsOutput.Event</code>
 */
class Event
{
    /**
...
class_alias(Event::class, \Eolymp\Judge\WatchAnnouncementsOutput_Event::class);
