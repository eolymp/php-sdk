...
/**
 * Protobuf type <code>eolymp.executor.StressReport.Status</code>
 */
class Status
{
    /**
    ...
    const COMPLETE = 5;
    /**
     * failed due to an error in the task, such as a compilation error
     *
...
class_alias(Status::class, \Eolymp\Executor\StressReport_Status::class);
