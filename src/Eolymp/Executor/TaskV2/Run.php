 ...
 *
 * Generated from protobuf message <code>eolymp.executor.TaskV2.Run</code>
 */
class Run extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .eolymp.executor.TaskV2.Step steps = 20;</code>
     */
    private $steps;
     ...
     *           Labels used to match constraints and preconditions.
     *     @type \Eolymp\Executor\TaskV2\Step[]|\Google\Protobuf\Internal\RepeatedField $steps
     *           Steps to execute the run
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .eolymp.executor.TaskV2.Step steps = 20;</code>
     * @param \Eolymp\Executor\TaskV2\Step[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setSteps($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Eolymp\Executor\TaskV2\Step::class);
        $this->steps = $arr;
...
class_alias(Run::class, \Eolymp\Executor\TaskV2_Run::class);
