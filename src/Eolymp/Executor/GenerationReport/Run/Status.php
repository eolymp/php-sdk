...
namespace Eolymp\Executor\GenerationReport\Run;

use UnexpectedValueException;

/**
 * Protobuf type <code>eolymp.executor.GenerationReport.Run.Status</code>
 */
class Status
{
    /**
...
class_alias(Status::class, \Eolymp\Executor\GenerationReport_Run_Status::class);
