...
namespace Eolymp\Executor\Job\Actor;
 ...
 *
 * Protobuf type <code>eolymp.executor.Job.Actor.OutputFormat</code>
 */
class OutputFormat
{
    /**
     ...
     *
     * Generated from protobuf enum <code>TESTLIB_OUTPUT = 1;</code>
     */
    const TESTLIB_OUTPUT = 1;

    private static $valueToName = [
        self::EXIT_CODE => 'EXIT_CODE',
        self::TESTLIB_OUTPUT => 'TESTLIB_OUTPUT',
    ];
...
class_alias(OutputFormat::class, \Eolymp\Executor\Job_Actor_OutputFormat::class);
