...
namespace Eolymp\Executor\EvaluationReport\Run;

use UnexpectedValueException;

/**
 * Protobuf type <code>eolymp.executor.EvaluationReport.Run.Status</code>
 */
class Status
{
    /**
    ...
    /**
     * run can't be executed due to dependencies
     *
...
class_alias(Status::class, \Eolymp\Executor\EvaluationReport_Run_Status::class);
