...
namespace Eolymp\Executor\Script;
 ...
 *
 * Generated from protobuf message <code>eolymp.executor.Script.File</code>
 */
...
class_alias(File::class, \Eolymp\Executor\Script_File::class);
